...
CREATE TABLE TBL_FIELD_TRIP(
	...
	FIELD_TRIP_CONTENT VARCHAR(255),
...
SELECT 
	PRODUCT_NAME || ' 반품' AS "상품명",
	SUM(PRODUCT_STOCK) AS "상품별 재고",
	ROUND(AVG(PRODUCT_PRICE)) || '원' AS "상품별 평균 가격"
FROM TBL_PRODUCT
...
SELECT FLOOR(10000 / PRODUCT_PRICE) || '개' AS "만원의 행복 개수"
FROM TBL_PRODUCT
GROUP BY PRODUCT_PRICE;
